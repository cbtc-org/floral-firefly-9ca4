...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/floral-firefly-9ca4
```

A live public deployment of this template is available at [https://floral-firefly-9ca4.templates.workers.dev](https://floral-firefly-9ca4.templates.workers.dev)
